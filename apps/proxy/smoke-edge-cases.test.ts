...
describe("Proxy pressure tests", () => {
  ...
  // [MOVED 2026-04-16] "Concurrent request handling" relocated to stress-feature-concurrency.test.ts — see docs/internal/test-tier-taxonomy.md
  ...
  // [MOVED 2026-04-16] "Proxy resilience" burst tests relocated to stress-feature-concurrency.test.ts — see docs/internal/test-tier-taxonomy.md
});
